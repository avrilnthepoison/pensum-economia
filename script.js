...
const materias = {
  ...
  "3321": { nombre: "Historia Económica I", creditos: 4, semestre: 2, prelaciones: ["3311"], descripcion: "Estudio de los procesos económicos históricos" },
  "3251": { nombre: "Contabilidad General", creditos: 3, semestre: 2, prelaciones: [], descripcion: "Principios básicos de contabilidad financiera" },
  ...
  "3421": { nombre: "Estadística I", creditos: 4, semestre: 4, prelaciones: ["3412"], descripcion: "Estadística descriptiva e inferencial" },
  "3131": { nombre: "Macroeconomía I", creditos: 4, semestre: 4, prelaciones: ["3112"], descripcion: "Modelos de ingreso nacional y política fiscal" },
  ...
  "3142": { nombre: "Economía Internacional II", creditos: 4, semestre: 6, prelaciones: ["3141"], descripcion: "Finanzas internacionales y tipo de cambio" },
  ...
  "3231": { nombre: "Metodología de la Investigación", creditos: 3, semestre: 6, prelaciones: ["3422"], descripcion: "Diseño y ejecución de proyectos de investigación" },
  ...
  "3312": { nombre: "Estado y Economía", creditos: 3, semestre: 7, prelaciones: ["3322"], descripcion: "Relación entre instituciones y política económica" },
  ...
  "3241": { nombre: "Política Económica I", creditos: 4, semestre: 8, prelaciones: ["3132"], descripcion: "Instrumentos de política económica" },
  "3161": { nombre: "Economía Política Clásica", creditos: 4, semestre: 8, prelaciones: ["3111"], descripcion: "Autores clásicos y sus teorías" },
  "3313": { nombre: "Problemas Sociales Contemporáneos", creditos: 4, semestre: 9, prelaciones: ["3312"], descripcion: "Desigualdad, pobreza y exclusión" },
